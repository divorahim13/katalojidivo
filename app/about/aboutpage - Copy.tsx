...
const TIMELINE = [
  { year: '2021', title: 'Awal Mula', desc: 'Lahir di tengah tantangan, Kataloji memulai perjalanannya sebagai "Coffee Stall" kecil dengan misi membawa kopi berkualitas terjangkau bagi warga Cipayung.', img: IMGS.awalmula, dir: 'left' as const },
  { year: '2022', title: 'Bertumbuh Bersama', desc: 'Kataloji menjadi titik kumpul komunitas. Dari diskusi kreatif hingga sekadar melepas penat — energi kalianlah yang membangun ruang ini.', img: IMGS.tumbuhbersama, dir: 'right' as const },
...
const FLOORS = [
  ...
  { num: 'ROOFTOP ✦', name: 'Sky Rooftop',  desc: 'Open air di malam hari. Bintang di atas, kopi di tangan, cerita tanpa akhir. Lantai untuk sunset-an.',                    img: IMGS.interior3,   offset: 'md:mt-32' },
]
      ...
      <section className="px-8 md:px-20 py-20 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <AnimateIn direction="right" className="md:col-span-5 relative">
          <div className="aspect-[4/5] rounded-2xl overflow-hidden rotate-2 shadow-lg">
            <Image src={IMGS.about} alt="Interior Kataloji" fill className="object-cover" sizes="500px" priority />
          </div>
        </AnimateIn>
      </section>

...
const EVENTS = [
  { date:'SETIAP JUM&apos;AT & SABTU · 19:00',  title:'Friday Night Live Music 🎸', desc:'Live performance dari musisi lokal Jakarta Timur. Free entry, booking meja dianjurkan.', tag:'RUTIN',    tagColor:'bg-primary', img: IMGS.event2, cta:'Book Tempat', href:'https://wa.me/62' },
  { date:'SABTU, 29 MARET · 10:00',              title:'Workshop Latte Art ☕',     desc:'Pelajari teknik latte art dari barista kami. Semua alat disediakan. Terbatas 15 peserta.', tag:'WORKSHOP',  tagColor:'bg-[#803c1a]', img: IMGS.event3, cta:'Daftar Sekarang', href:'https://wa.me/62' },
  { date:'SABTU, 22 MARET 14:00–22:00',           title:'Mobile Legends', desc:'Mari buktikan team kamu terkuat di Kataloji Caffe', tag:'LIMITED',   tagColor:'bg-yellow-600', img: IMGS.event4, cta:'Daftar Sekarang', href:'https://wa.me/62' },
]
          ...
          <div className="promo-glow bg-[#803c1a] rounded-3xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 min-h-[300px]">
              ...
              <div className="relative h-48 md:h-auto overflow-hidden">
                <Image src={IMGS.event1} alt="Rooftop promo" fill className="object-cover" sizes="600px" loading="lazy" />
